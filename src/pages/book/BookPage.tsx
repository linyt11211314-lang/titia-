          ...
          <div key={view} className="fade-up">
            ...
            {view === 'home' && (
              <>
                ...
                <div className="sticky top-0 z-30 bg-bg pb-2 pt-2">
            ...
            {view === 'bills' && (
              <>
                ...
                <div className="sticky top-0 z-30 bg-bg pb-1 pt-2">
                  {/* 操作栏：标题 + 编辑/记一笔 */}
                  <div className="mb-2 flex items-center justify-between">
                    <h2 className="text-lg font-semibold text-ink">小账</h2>
                    <div className="flex items-center gap-2">
            ...
            {view === 'analysis' && (
              <>
                {/* 吸顶固定区（短头：标题 + 月份筛选 + 三卡；消费趋势等高卡已移出区外）。
                    高度远小于滚动容器(530px)，CSS sticky 正常生效、不透明头部盖住下方内容，不再透出。 */}
                <div className="sticky top-0 z-30 bg-bg pt-2">
                <div className="mb-2 flex items-center justify-between">
